 ...
 * http://whowin.cn/
 *
 * Example of IPC using UNIX domain socket(sendto()/recvfrom()).
 * Compiled with gcc version 9.4.0 (Ubuntu 9.4.0-1ubuntu1~20.04.1).
 * Tested on Linux 5.4.0-139-generic #156-Ubuntu SMP Fri Jan 20 17:27:18 UTC 2023 x86_64 x86_64 x86_64 GNU/Linux.
 *
 * To compile: $ gcc -Wall sendto-recvfrom.c -o sendto-recvfrom
 * Usage: $ ./sendto-recvfrom
 *
...
#define MSG_FROM_CLIENT     "Hello server. This message is from client."
