...
* 如果是按照我以前的文章[《在DOS下的DJGPP+RHIDE安装实作》][article01的步骤进行的安装，那我们已经具备了上述条件，可选的软件我们放弃，其他的部分我们应该有：
  1. DJGPP 2.03
  2. GCC compiler 4.23
  3. Binutils 2.17
  4. GNU make 3.79
...
* 完全符合条件。
* 如果有些软件你没有安装，可以在下面网址下找到这些软件：[djgpp相关软件][web03]
* (2023年4月21日注：很高兴这个链接还健在，不过为了以防万一，我已经下载了这个地方与djgpp有关的所有东东，稍后会提供有效的下载地址)
  1. GCC compilier 4.23 (gcc423b.zip)    4422 kb
  2. Binutils 2.17 (bnu217b.zip)        3962 kb
  3. GNU make 3.79 (mak3791b.zip)        267 kb
  4. Texinfo 4.11 (txi411b.zip)         888 kb
...
## 3. 下载Allegro
* 在下面网址可以下载到完整的Allegro：[http://ftp.delorie.com/pub/djgpp/current/v2tk/allegro/][web04]
...
* Allegro的安装及其简单，按以下步骤：
  ...
  - 解压缩这两个文件
    ...
    + 如果你没有unzip32，但希望使用这个解压缩程序，可以在下面地址下载：[http://ftp.delorie.com/pub/djgpp/current/unzip32.exe][web05]
