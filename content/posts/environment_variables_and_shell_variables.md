...
* 你可能用 *ps aux(ps -ef)* 命令发现1号进程是 **/sbin/init**，而不是 **systemd**，但你用 *ls -l /sbin/init* 看一下就会恍然大悟
  ![1号进程](first_process.png)
  **图1：1号进程**
  ![init进程指向systemd](init_point_to_systemd.png)
